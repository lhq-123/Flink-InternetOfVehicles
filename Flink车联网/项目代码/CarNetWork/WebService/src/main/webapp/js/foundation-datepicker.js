...
! function($) {
    ...
    Datepicker.prototype = {
        ...
        fillDow: function() {
            ...
            while (dowcomt < this.weekStart + 7) {
                html += '<th class="dow">' + dates[this.language].daysMin[(dowcomt++) % 7] + '</th>';
            }
            html += '</tr>';
    ...
    var DPGlobal = {
        ...
        parseDate: function(date, format, language) {
            ...
            if (parts.length == format.parts.length) {
                for (var i = 0, comt = format.parts.length; i < comt; i++) {
