package com.alex.Streaming.Sink.TripDrive;
 ...
 */
public class TripDriveSampleToHBase extends RichSinkFunction<String[]> {
    //定义日志操作对象
    private final static Logger logger = LoggerFactory.getLogger(TripDriveSampleToHBase.class);
    //定义操作的hbase的表名
    ...
    public TripDriveSampleToHBase(String tableName){
