package com.alex.Streaming.Task.TripDrive;
...
public class TripDriveTask extends BaseTask {
    public static void main(String[] args) throws IllegalAccessException, InstantiationException {
        ...
        tripDriveDataStreamWindow.apply(new TripDriveSampleWindowFunction()).addSink(new TripDriveSampleToHBase("TRIPDB:trip_sample"));
        //TODO 11）驾驶行程划分与入库
