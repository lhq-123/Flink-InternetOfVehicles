 ...
 */
public class MysqlElectricFenceVehicleInfoSource extends RichSourceFunction<HashMap<String,Long>> {

    private Logger logger = LoggerFactory.getLogger(MysqlElectricFenceVehicleInfoSource.class);
