...
public class DateUtil {
    ...
    public static String getRangeTime(String dateTime) {
        ...
        int minute = StringUtil.convertStringtoInt(dateTime.split(" ")[1].split(":")[1]);
//		 String second = dateTime.split(" ")[1].split(":")[2];
        if(minute+(5-minute % 5) == 60){
            return date+" "+hour+":"+StringUtil.fulfuill((minute-(minute % 5))+"")+"~"+date+" "+StringUtil.fulfuill((Integer.parseInt(hour)+1)+"")+":00";
        }
        return date+" "+hour+":"+StringUtil.fulfuill((minute-(minute % 5))+"") +"~" + date+" "+hour+":"+StringUtil.fulfuill((minute+(5-minute % 5))+"");
    }
}
